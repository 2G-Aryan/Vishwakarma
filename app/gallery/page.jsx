  ...
  return (
    <div className='max-w-screen-xl mx-auto py-10 grid grid-cols-2 md:grid-cols-4 gap-4'>
      <div className='flex flex-col gap-4'>
        ...
        <div>
          <img className="w-full h-full object-cover rounded-lg hover:scale-90 transition-all" src="/img/bathroom.jpeg" alt="no" />
        </div>
        <div>
        ...
        <div>
          <img className="w-full h-full object-cover rounded-lg hover:scale-90 transition-all" src="/imgs/q1.jpeg" alt="no" />
        </div>
        <div>
          <img className="w-full h-full object-cover rounded-lg hover:scale-90 transition-all" src="/imgs/q2.jpeg" alt="no" />
        </div>
        <div>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div>
          <img className="w-full h-full object-cover rounded-lg hover:scale-90 transition-all" src="/img/p8.jpeg" alt="no" />
        </div>
        <div>
          <img className="w-full h-full object-cover rounded-lg hover:scale-90 transition-all" src="/img/p1.jpeg" alt="no" />
        </div>
        ...
        <div>
          <img className="w-full h-full object-cover rounded-lg hover:scale-90 transition-all" src="/imgs/q5.jpeg" alt="no" />
        </div>
    ...
    <div>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div>
          <img className="w-full h-full object-cover rounded-lg hover:scale-90 transition-all" src="/imgs/q11.jpeg" alt="no" />
        </div>
        <div>
